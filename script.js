...
function adjustBackground() {
    ...
    if (gameScreen) {
        if (gameSelectContent.classList.contains("active") || formContent.classList.contains("active")) {
            ...
            gameScreen.style.backgroundSize = "contain"; // Fit fully without cropping
            gameScreen.style.backgroundPosition = "center"; // Center the background
    ...
    if (header) {
        ...
        header.style.backgroundSize = "contain"; // Fit fully without cropping
        header.style.backgroundPosition = "center"; // Center the background
